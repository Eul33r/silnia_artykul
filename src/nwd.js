...
(() => {
const formularz = document.getElementById("gcdForm");
const pole_n = document.getElementById("gcd_liczba_a");
const pole_k = document.getElementById("gcd_liczba_b");
const wynik = document.getElementById("wynik_gcd");
...
formularz.addEventListener("submit", function (event) {
    ...
    wynik.innerHTML = `\\(NWD(${a}, ${b}) = ${result.toString()}\\)`;
